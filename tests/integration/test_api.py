...
class TestAPIIntegration:
    ...
    async def test_create_memory(self, base_url):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                f"{base_url}/memory/", json=memory_data, timeout=30.0
            )
    ...
    async def test_list_memories(self, base_url):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{base_url}/memory/", params={"limit": 10}, timeout=30.0
            )
    ...
    async def test_memory_lifecycle(self, base_url):
        ...
        async with httpx.AsyncClient() as client:
            ...
            get_response = await client.get(
                f"{base_url}/memory/{memory_id}", timeout=30.0
            )
            ...
            update_response = await client.patch(
                f"{base_url}/memory/{memory_id}", json={"outdated": True}, timeout=30.0
            )
    ...
    async def test_memory_not_found(self, base_url):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{base_url}/memory/nonexistent-id", timeout=30.0
            )
    ...
    async def test_invalid_memory_data(self, base_url):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                f"{base_url}/memory/", json=invalid_data, timeout=30.0
            )
